  ...
  return (
    <div className="grid grid-cols-3 gap-3 my-4">
       <div className="bg-white rounded-lg p-3.5 shadow-lg flex items-center gap-3 animate-fadeUp">
        <div className="w-9 h-9 rounded-lg bg-green-50 text-green-600 flex items-center justify-center text-lg">✅</div>
      ...
      <div className="bg-white rounded-lg p-3.5 shadow-lg flex items-center gap-3 animate-fadeUp" style={{ animationDelay: '0.05s' }}>
        <div className="w-9 h-9 rounded-lg bg-amber-50 text-amber-700 flex items-center justify-center text-lg">⏳</div>
        <div className='text-center'>
      ...
      <div className="bg-white rounded-lg p-3.5 shadow-lg flex items-center gap-3 animate-fadeUp" style={{ animationDelay: '0.1s' }}>
        <div className="w-9 h-9 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center text-lg">⏱</div>
        <div className='text-center'>
